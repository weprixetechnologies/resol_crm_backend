...
import { assertSchemaCompatibility, DEFAULT_SCHEMA, quoteSchemaName, runMigrations, } from './migrator';
/**
    ...
    constructor(connection) {
        ...
        if (isPgPool(connection)) {
            ...
            const _a = typeof connection === 'string'
                ...
                : connection, { schema, skipVersionCheck, migrate, skipMigrations } = _a, poolConfig = __rest(_a, ["schema", "skipVersionCheck", "migrate", "skipMigrations"]);

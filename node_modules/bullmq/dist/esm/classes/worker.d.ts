...
export interface WorkerListener<DataType = any, ResultType = any, NameType extends string = string, ProgressType extends JobProgress = JobProgress> extends IoredisListener {
    /**
     * Listen to 'active' event.
     *
     * This event is triggered when a job enters the 'active' state.
     */
    active: (job: Job<DataType, ResultType, NameType, ProgressType>, prev: string) => void;
    /**
     ...
     */
    completed: (job: Job<DataType, ResultType, NameType, ProgressType>, result: ResultType, prev: string) => void;
    /**
     ...
     */
    failed: (job: Job<DataType, ResultType, NameType, ProgressType> | undefined, error: Error, prev: string) => void;
    /**
     ...
     * world.
     */
    progress: (job: Job<DataType, ResultType, NameType, ProgressType>, progress: ProgressType) => void;
    /**
 ...
 *
 */
export declare class Worker<DataType = any, ResultType = any, NameType extends string = string, B extends IQueueBackend = RedisQueueBackend, ProgressType extends JobProgress = JobProgress> extends QueueBase<B> {
    ...
    constructor(name: string, processor?: string | URL | null | Processor<DataType, ResultType, NameType, ProgressType>, opts?: WorkerOptions, backendFactory?: BackendFactory<B>);
    /**
    ...
    emit<U extends keyof WorkerListener<DataType, ResultType, NameType, ProgressType>>(event: U, ...args: Parameters<WorkerListener<DataType, ResultType, NameType, ProgressType>[U]>): boolean;
    off<U extends keyof WorkerListener<DataType, ResultType, NameType, ProgressType>>(eventName: U, listener: WorkerListener<DataType, ResultType, NameType, ProgressType>[U]): this;
    on<U extends keyof WorkerListener<DataType, ResultType, NameType, ProgressType>>(event: U, listener: WorkerListener<DataType, ResultType, NameType, ProgressType>[U]): this;
    once<U extends keyof WorkerListener<DataType, ResultType, NameType, ProgressType>>(event: U, listener: WorkerListener<DataType, ResultType, NameType, ProgressType>[U]): this;
    protected callProcessJob(job: Job<DataType, ResultType, NameType, ProgressType>, token: string, signal?: AbortSignal): Promise<ResultType>;
    protected createJob(data: JobJson, jobId: string): Job<DataType, ResultType, NameType, ProgressType>;
    /**
     *
     ...
     */
    getNextJob(token: string, { block }?: GetNextJobOptions): Promise<Job<DataType, ResultType, NameType, ProgressType>>;
    private _getNextJob;
    /**
    ...
    protected moveToActive(token: string, name?: string): Promise<Job<DataType, ResultType, NameType, ProgressType>>;
    private waitForJob;
    ...
    protected nextJobFromJobData(jobData?: JobJson, jobId?: string, token?: string): Promise<Job<DataType, ResultType, NameType, ProgressType>>;
    processJob(job: Job<DataType, ResultType, NameType, ProgressType>, token: string, fetchNextCallback?: () => boolean): Promise<void | Job<DataType, ResultType, NameType, ProgressType>>;
    private getUnrecoverableErrorMessage;
    protected handleCompleted(result: ResultType, job: Job<DataType, ResultType, NameType, ProgressType>, token: string, fetchNextCallback?: () => boolean, span?: Span): Promise<Job<DataType, ResultType, NameType, ProgressType>>;
    protected handleFailed(err: Error, job: Job<DataType, ResultType, NameType, ProgressType>, token: string, fetchNextCallback?: () => boolean, span?: Span): Promise<Job<DataType, ResultType, NameType, ProgressType>>;
    /**
     *
